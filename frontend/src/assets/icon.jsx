...
export const closeIcon = (
  <svg
    className="w-28 h-28 text-red-800 dark:text-white"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const tickIcon = (
  <svg
    className="w-40 h-40 text-green-600 dark:text-white"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const creditcardIcon1 = (
  <svg
    className="w-8 h-8 text-yellow-700 dark:text-white"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    viewBox="0 0 24 24"
...
export const SearchIcon = (
  <svg
    className="w-5 h-5 dark:text-white absolute top-2.5 left-3"
    style={{ color: "#747474" }}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
export const filterIcon = (
  <svg
    className="w-5 h-6 text-gray-600 dark:text-white"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    viewBox="0 0 24 24"
...
export const pfpIcon = (
  <svg
    className="w-5 h-5 text-orange-300 dark:text-white"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    viewBox="0 0 24 24"
