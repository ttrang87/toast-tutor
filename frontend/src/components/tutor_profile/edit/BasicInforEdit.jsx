        ...
        <div>
            <div className="h-52 bg-gray-200 rounded-tl-xl rounded-tr-xl relative"
                ...
                <div className="absolute top-56 right-8">
                    <button onClick={() => setIsModalOpen(true)}
                        className='p-2 rounded-full bg-transparent hover:bg-gray-400/20 transition-all duration-200'>{EditIcon}</button>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-24 left-12 z-10">
                        <div className="w-40 h-40 bg-gray-300 rounded-full border-4 border-white relative">
                            ...
                            <button className="absolute bottom-0 right-3 bg-gray-200 p-1 rounded-full border-2 border-white cursor-pointer"
            ...
            <div className='flex flex-col px-10 py-10 mt-4 gap-1'>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='text-3xl font-bold pb-2 text-yellow-800'>{tutorHourlyRate}$/h</div>
                </div>
            </div>
            <BasicInforModal
                profileId={id}
